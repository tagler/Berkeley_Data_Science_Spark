# Databricks notebook source exported at Sat, 20 Aug 2016 18:50:36 UTC
# MAGIC %md
...
altPowerPlantDF = sqlContext.read.format('com.databricks.spark.csv') \
...
# MAGIC %sql
# MAGIC select AT as Temperature, PE as Power 
# MAGIC from power_plant
...
# MAGIC %sql
# MAGIC select PE as Power, V as ExhaustVacuum 
# MAGIC from power_plant
...
# MAGIC %sql
# MAGIC select AP as Pressure, PE as Power 
# MAGIC from power_plant
...
# MAGIC %sql
# MAGIC select PE as Power, RH as Humidity
# MAGIC from power_plant
