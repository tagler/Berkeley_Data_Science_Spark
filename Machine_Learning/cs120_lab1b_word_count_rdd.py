# Databricks notebook source exported at Wed, 13 Jul 2016 11:59:57 UTC
# MAGIC %md
...
top15WordsAndCounts = wordCount(shakeWordsRDD).takeOrdered(15, key = lambda a : -a[1])
